...
//BACKGROUND CHANGER
  ...
  $(function() {
      $("#button-bg").click(function() {
          $("body").css({
              "background": "url('/media/img/bg5.jpg')no-repeat center center fixed"
          });
      });
      $("#button-bg2").click(function() {
          $("body").css({
              "background": "url('/media/img/bg2.jpg')no-repeat center center fixed"
          });
      });
      ...
      $("#button-bg5").click(function() {
          $("body").css({
              "background": "url('/media/img/giftly.png')repeat"
          });
      ...
      $("#button-bg7").click(function() {
          $("body").css({
              "background": "url('/media/img/bg3.png')repeat"
          });

      });
      $("#button-bg8").click(function() {
          $("body").css({
              "background": "url('/media/img/bg8.jpg')no-repeat center center fixed"
          });
      });
      $("#button-bg9").click(function() {
          $("body").css({
              "background": "url('/media/img/bg9.jpg')no-repeat center center fixed"
          });
      });

      $("#button-bg10").click(function() {
          $("body").css({
              "background": "url('/media/img/bg10.jpg')no-repeat center center fixed"
          });
      });
      $("#button-bg11").click(function() {
          $("body").css({
              "background": "url('/media/img/bg11.jpg')no-repeat center center fixed"
          });
      });
      $("#button-bg12").click(function() {
          $("body").css({
              "background": "url('/media/img/bg12.jpg')no-repeat center center fixed"
          });
      });

      $("#button-bg13").click(function() {
          $("body").css({
              "background": "url('/media/img/bg13.jpg')repeat"
          });
